...
cd / && rm -rf /bookbot && wget https://ghproxy.com/https://raw.githubusercontent.com/vpei/book/main/book.zip -O bookbot.zip && unzip -d /bookbot/ bookbot.zip && rm -rf /bookbot.zip
